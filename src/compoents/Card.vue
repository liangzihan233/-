    ...
    <div class="card-container">
        <div class="card-background" id="capture">
            <div class="card">
                ...
                <div class="times">
                    <div class="sentence">
                        <div class="tag-template">相恋在</div>
                        <div>
                            <span class="tag-content" id="first-time">2024年3月29日</span>
                        </div>
                    </div>
                    ...
                    <div class="sentence">
                        ...
                        <div>
                            <span class="tag-content" id="time-from-today">{{ daysFromFirstDate }}</span>
                            <span class="tag-template">天</span>
                        </div>
                    </div>

                    <div class="sentence">
                        <div class="tag-template">出片</div>
                        <div>
                            <span class="tag-content" id="time-from-today">411</span>
                            <span class="tag-template">张</span>
                        </div>    
                        <span class="tag-content">互相忘记生日！</span>
                    </div>
                ...
                <div class="tags">
                    ...
                    <div class="right">
                        ...
                        <div class="qrcode">
                            <img src="../../public/dog/1.png" alt="QrCode">
                        </div>
                    </div>
                </div>
...
function calculateDaysFromDate() {
    ...
    daysFromFirstDate.value = daysDiff;
}
